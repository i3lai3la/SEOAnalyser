...
namespace K.SEOAnalyser.Web
{
    ...
    public class DbInit : IDbInit
    {
        ...
        public DbInit(SeoContext seoContext)
        {
        ...
        private void SeedStopWords()
        {
            if (_seoContext.Words.Count() > 0)
                return;
            ...
            List<string> stopWords = new List<string>
            {
                ...
                { "nevertheless" }, { "next" }, { "nine" }, { "no" }, { "nobody" }, { "none" }, { "nor" }, { "not" }, { "nothing" },
            ...
            foreach(string stopWord in stopWords)
            {
                ...
                {
                    Id = Guid.NewGuid(),
                    Value = stopWord.ToLower(),
                    IsActive = true,
                    WordType = WordType.STOPWORD,
                    CreatedBy = "StartUp",
